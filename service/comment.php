                ...
                <div class="table-responsive">
                    <table class="display" id="example">
                        ...
                        <tbody>
                            <?php
                            if ($row['rule'] == 99) {
                                $result1 = mysqli_query($db, "SELECT * FROM `dv_cmt` ORDER BY id DESC LIMIT 0,400");
                            } else {
                                $result1 = mysqli_query($db, "SELECT * FROM `dv_cmt` WHERE `user` = '" . $login . "' ORDER BY id DESC LIMIT 0,400");
                            }
                            if ($result1) {
