 ...
 <? } ?>-->
        ...
        <div class="card border-danger border-bottom border-3 border-0">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" <? if ($sv4 == 'on') {
                                                            ...
                                                            echo 'disabled';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo '<span class="badge bg-danger">Mở lại sau 18h</span>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
           ...
           -->
                    ...
                    <div class="form-check">
                        <input class="form-check-input"  id="flexRadioDefault1" type="radio" name="sv" value="9" data-bs-toggle="collapse" data-bs-target="#sv9" aria-expanded="false" aria-controls="sv9" /><label class="form-check-label" for="flexRadioDefault1">Server Like 9 ( Tốc độ 5k-10k / ngày . Like clone kém chất lượng tụt nhiều, max 80k ) <span style="color:Blue;"><?= $gia9; ?>₫</span> <span class="badge bg-warning">trung bình</span></label>
                    </div>
                    <!-- <div class="form-check">
