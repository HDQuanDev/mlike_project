                  ...
                  <!--      <div class="form-check">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" <? if ($sv4 == 'on') {
                                                            ...
                                                            echo 'disabled';
                                                        } ?> id="flexRadioDefault1" type="radio" name="sv" value="4" data-bs-toggle="collapse" data-bs-target="#sv4" aria-expanded="false" aria-controls="sv4" /><label class="form-check-label" for="flexRadioDefault1">Server Like 4 (<span style="color: Darkorange;"> Tốc độ siêu nhanh, like BETA gần như k tụt,mỗi ID chỉ được mua 1 lần ,<span style="color: red;">[ĐỌC KĨ LƯU Ý]</span>  Max 5k) <span style="color:red;"><?= $gia4; ?>₫</span> <? if ($sv4 == 'off') {
