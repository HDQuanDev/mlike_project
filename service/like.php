                  ...
                  <!--      <div class="form-check">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" <? if ($sv4 == 'on') {
                                                            ...
                                                            echo 'disabled';
                                                        } ?> id="flexRadioDefault1" type="radio" disabled name="sv" value="4" data-bs-toggle="collapse" data-bs-target="#sv4" aria-expanded="false" aria-controls="sv4" /><label class="form-check-label" for="flexRadioDefault1">Server Like 4 (<span style="color: Darkorange;"> <span style="color: red;">[ĐỌC KĨ LƯU Ý]</span> Tốc độ siêu nhanh, like BETA gần như k tụt,mỗi ID chỉ được mua 1 lần , Max 5k) <span style="color:red;"><?= $gia4; ?>₫</span> <? if ($sv4 == 'off') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo '<span class="badge bg-danger">Đang Update fix lỗi sẽ sớm mở lại</span>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                    ...
                    <div class="form-check">
                        <input class="form-check-input"  id="flexRadioDefault1" type="radio" name="sv" value="5" data-bs-toggle="collapse" data-bs-target="#sv2" aria-expanded="false" aria-controls="sv2" /><label class="form-check-label" for="flexRadioDefault1">Server Like 5 ( Tốc độ trung mình, mở giới hạn quá tải tự đóng mở, ib có hỗ trợ chạy nhanh đơn trên 1k. fb đang quét die tụt nhiều <span style="color: red;"></span> <span style="color: red;"> max 50k </span> ) <span style="color:red;"><?= $gia5; ?>₫</span> <span class="badge bg-success">Tạm ổn</span></label>
                    </div>
                        ...
                        <div class="alert alert-warning" role="alert">
                            ...
                            <p> - Cách lấy link trên máy tính vui lòng kích vào thời gian đăng bài, kích vào ảnh là sai nhé <br>
                                ...
                                *<span style="color: red;"> Chú ý </span> : bật nút like ở trong cài đặt ra trước khi cài (Vào cài đặt => bài viết công khai => bật công khai hết ra nhé <br>
                                ...
                                - Đối với link chia sẽ liên kết khác, vidu chia sẽ link youtube vui lòng dùng máy tính để lấy link. Đt get id lỗi chạy k được nhé <br>
