        ...
        <div class="card border-danger border-bottom border-3 border-0">
            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" checked id="flexRadioDefault1" type="radio" name="sv" value="10" data-bs-toggle="collapse" data-bs-target="#sv10" aria-expanded="false" aria-controls="sv10" /><label class="form-check-label" for="flexRadioDefault1">Server View 10 (<b><?= $gia10; ?>₫</b>) ( <span style="color: red;">Min 1k . View rẻ như cho nên không hỗ trợ nếu lỗi, lãi mỗi tình cảm. Test ít thấy lên thì mua tiếp </span> ) <span class="badge bg-danger">Đang delay lâu cân nhắc trước khi dùng</span></label>
