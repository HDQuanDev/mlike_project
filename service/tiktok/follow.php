        ...
        <div class="card border-danger border-bottom border-3 border-0">
            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" checked id="flexRadioDefault1" type="radio" name="sv" value="3" data-bs-toggle="collapse" data-bs-target="#sv3" aria-expanded="false" aria-controls="sv3" /><label class="form-check-label" for="flexRadioDefault1">Server Follow 3 (<b><?= $gia3; ?>₫</b>) ( Follow việt, tốc độ chậm 200-500 follow / ngày, tài nguyên ít cài ít lên được hãy cài tiếp ,Max 10k+ follow )<span class="badge danger">Chậm</span> </label></label>
