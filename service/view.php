         ...
         <? if (!isset($_POST['add'])) { ?>
                        <script>
                            function sayHello() {
                                ...
                                sangml.innerHTML = "<img class='card-img-top' src='https://daotao.ulis.vnu.edu.vn/files/uploads/2018/04/thong-bao660x350-600x350.png'><hr><big><center style='color:#3794ff;'> FB đang fix view tốc độ hiện tại rất chậm, hệ thống đang cố gắng xử lý đơn done trong 24h</big></b>";
                                swal({
                                    content: sangml,
                                    buttons: false
                                });
        ...
        <div class="card border-danger border-bottom border-3 border-0">
            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" checked type="radio" name="sv" value="5" id="td" oninput="calc()" /><label class="form-check-label" for="flexRadioDefault1"> Server View 5 <span style="color:Blue;">[View 3s] [ Tốc độ ưu tiên, tốc độ 5k-10k/ngày )</span> <span style="color:red;">[Chạy được Reel] </span> <span style="color:Blue;"><?= $gia4; ?>₫ </span> <? if ($sv5  == 'off') {
                                                                                                                                                                                                                                                                                                                                                                                                                                echo '<span class="badge bg-danger">Quá tải</span>';
                                                                                                                                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                echo '<span class="badge bg-success">Hoạt động</span>';
                                                                                                                                                                                                                                                                                                                                                                                                                            } ?>
