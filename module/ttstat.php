            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?
                            $ctime = mysqli_query($db, "SELECT * FROM `dv_other` WHERE `dv` = 'tiktok_view' AND `id` > '0' AND `time` > '1699909582' AND (`trangthai` = '1' OR `trangthai` = '3')");
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?
                            $ctime = mysqli_query($db, "SELECT * FROM `dv_other` WHERE `dv` = 'tiktok_like' AND `id` > '0' AND `time` > '1699909582' AND (`trangthai` = '1' OR `trangthai` = '3')");
                            $ctime = mysqli_num_rows($ctime);
