            ...
            if ($tko == '1') {
                ...
                if (empty($id)) {
                    ...
                    if ($sv == '1') {
                        ...
                        if ($lcheck > '20000') {
                            $array["status"] = 'error';
                            $array["msg"] = 'Số lượng tối đa của 1 ID có thể mua là 20000 Like (Bạn có thể mua thêm ' . $mcheck . ' Like cho ID nay) hoặc bạn đã mua quá 3 lần vui lòng dùng server khác!';
                        } else {
                            $nd1 = 'Tăng Like Fanpage ID:';
                            $bd = $tongtien;
                            $gt = '-';
