    ...
    window.location="' . $url . '#' . $id . '";
            ...
            <table class="table table-striped table-bordered" id="example">
                ...
                <tbody class="list">
                    ...
                    if ($_GET['status']) {
                        $dv = $_GET['status'];
                        $result1 = mysqli_query($db, "SELECT * FROM `dichvu` WHERE `trangthai` = '$dv' AND `nse` = '444' ORDER BY id DESC LIMIT 700");
                    } else {
                        $result1 = mysqli_query($db, "SELECT * FROM `dichvu` WHERE `nse` = '444' ORDER BY id DESC LIMIT 700");
                    }
                    if ($result1) {
