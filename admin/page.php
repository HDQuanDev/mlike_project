    ...
    window.location="' . $url . '#' . $id . '";
            ...
            <table class="table table-striped table-bordered" id="example">
                ...
                <tbody class="list">
                    ...
                    if ($_GET['status']) {
                        $dv = $_GET['status'];
                        $result1 = mysqli_query($db, "SELECT * FROM `dv_other` WHERE `trangthai` = '$dv' AND `dv` = 'fb_page' AND `nse` = 'Server Fanpage 2' ORDER BY id DESC LIMIT 1500");
                    } else {
                        $result1 = mysqli_query($db, "SELECT * FROM `dv_other` WHERE `dv` = 'fb_page' AND `nse` = 'Server Fanpage 2' ORDER BY id DESC LIMIT 1500");
                    }
                    if ($result1) {
