...
if ($result1) {
    ...
    while ($ro = mysqli_fetch_assoc($result1)) {
        ...
        if ($tt == 1 || $tt == 3) {
            ?>
                                    <td class="cn"><a href="?action=3&id=<?= $ro['id']; ?>">Đang Chạy</a> | <a href="?action=4&id=<?= $ro['id']; ?>">Bị Hủy</a> <?php if ($ro['nse'] == 'Server Fanpage 2') { ?>| <a href="?action=7&id=<?= $ro['id']; ?>">Hủy Hoàn</a> <?php } ?>| <a href="?action=2&id=<?= $ro['id']; ?>">Hoàn Thành</a></td>
                                <?php
        } else {
            echo '<td class="cn"></td>';
        }
