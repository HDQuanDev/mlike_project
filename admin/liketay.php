                ...
                <tbody class="list">
                    ...
                    ?>
                            <tr>
                                ...
                                if ($tt == 1 || $tt == 3) {
                                ?>
                                    <td class="cn"><a href="?action=3&id=<?= $ro['id']; ?>">Đang Chạy</a> | <a href="?action=4&id=<?= $ro['id']; ?>">Bị Hủy</a> <? if ($ro['nse'] == 'Server Share 4' || $ro['nse'] == 'Server Share 5') { ?>| <a href="?action=7&id=<?= $ro['id']; ?>">Hủy Hoàn</a> <? } ?>| <a href="?action=2&id=<?= $ro['id']; ?>">Hoàn Thành</a></td>
                                <?php
                                } else {
                                    echo '<td class="cn"></td>';
                                }
